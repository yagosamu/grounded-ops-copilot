...
| AGT-02 | Agent promotion benchmark | In progress: the frozen v1 comparison shows +25% relative multi-hop success but rejects Investigate at 2.7x Ask cost; T43 will record the routing decision |
